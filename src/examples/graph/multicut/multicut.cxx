...
#include "cnnef/graph/undirected_list_graph.hxx"
#include "cnnef/graph/optimization/multicut/multicut_objective.hxx"
#include "cnnef/graph/optimization/multicut/multicut_greedy_additive.hxx"

int main( int argc , char *argv[] ){

    

    // cnnef::graph::UndirectedGraph has contiguous
    ...
    // 
    // 
    typedef cnnef::graph::UndirectedGraph<> Graph;
    Graph graph(6);
    ...
    typedef cnnef::graph::MulticutObjective<Graph, float> MulticutObjective;
    ...
    {  
        ...
        typedef cnnef::graph::MulticutGreedyAdditive<MulticutObjective> MulticutSolver;
        typedef cnnef::graph::MulticutVerboseVisitor<MulticutObjective> MulticutVerboseVisitor;
